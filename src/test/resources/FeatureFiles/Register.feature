Feature: Register functionality scenarios
  ...
  Scenario Outline: Verify whether the user is able to register with valid credentials or invalid credentials
    ...
    Examples:
      ...
      | invalidEmail           | nam                                                                   | ho                                                                    | 01235561231                                                        | anhnam123                                       | anhnam123       | true     |                        |
      | invalidEmail           | nam                                                                   | ho                                                                    | 01235561231                                                        | anhnam123                                       | anhnam123       | true     | qweqweqweqwueyiquwyeiyqwiueyiqwyeiqywiuqwequwyeiyqwieyieyqiuweyqeyqwi@gmail.com                       |
      | invalidEmail           | nam                                                                   | ho                                                                    | 01235561231                                                        | anhnam123                                       | anhnam123       | true     | nam ho@gmail.com                     |
      | invalidEmail           | nam                                                                   | ho                                                                    | 01235561231                                                        | anhnam123                                       | anhnam123       | true     |  namho@gm                      |
      ...
      | invalidTelephone       | nam                                                                   | ho                                                                    | 012abc1235                                                                | anhnam123                                       | anhnam123       | true     |                        |
